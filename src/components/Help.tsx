  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• pdfedit erkennt Originalschrift, Fett/Kursiv, exakte Größe und Textfarbe automatisch',
        '• Erste Wahl ist die im PDF eingebettete Originalschrift selbst — sie wird direkt wiederverwendet, das Schriftbild ändert sich dadurch nicht. Nur wenn das nicht geht (Teilschrift ohne benötigte Zeichen, nicht eingebettete Schrift), wählt pdfedit die passende installierte Schrift vor',
        '• Muss ersetzt werden, steht im Dialog, welcher nächste Treffer bzw. Ersatz gewählt wurde (Arial↔Helvetica, Times New Roman↔Times, Courier New↔Courier sind metrisch austauschbar)',
        ...
        'Grenze: Manche PDFs enthalten gar keinen echten Text — „Drucken als PDF" wandelt Buchstaben oft in Vektorpfade um, Scans sind reine Bilder. pdfedit sagt das dann klar an; Korrekturen gehen dort über „Ersetzen", oder erst OCR ausführen.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• pdfedit detects the original font, bold/italic, exact size and text color automatically',
        '• First choice is the PDF’s own embedded font — it is reused directly, so the typeface does not change at all. Only when that is impossible (subset missing the needed characters, font not embedded) does pdfedit preselect the matching installed font',
        '• When a substitute is needed, the dialog says which closest match or fallback was chosen (Arial↔Helvetica, Times New Roman↔Times, Courier New↔Courier are metric twins)',
        ...
        'Limitation: some PDFs contain no real text at all — “print to PDF” often turns letters into vector paths, scans are plain images. pdfedit now says so clearly; use “Replace” there, or run OCR first.',
